...
// */
//
//public class Pizza_NoFileRead extends MenuItem {
//    /* attributes */
//    /** pizza flavour */
...
//     */
//    public Pizza_NoFileRead(String name, double price, int quantity, String flavour, String crust, String size) {
...
//     */
//    public Pizza_NoFileRead(String name, double price, int quantity, String flavour, String crust, String size, String extraTopping1) {
//        super(name, price, quantity); // constructs from MenuItem superclass
//
//        // extra toppings
...
//     */
//    public Pizza_NoFileRead(String name, double price, int quantity, String flavour, String crust, String size, String extraTopping1, String extraTopping2) {
//        super(name, price, quantity); // constructs from MenuItem superclass
//
//        // extra toppings
//        this.extraTopping1 = extraTopping1;
...
//     */
//    public Pizza_NoFileRead(String name, double price, int quantity, String flavour, String crust, String size, String extraTopping1, String extraTopping2, String extraTopping3) {
//        super(name, price, quantity); // constructs from MenuItem superclass
//
//        // extra toppings
//        this.extraTopping1 = extraTopping1;
...
//        Pizza_NoFileRead pizza1 = new Pizza_NoFileRead(); // creates a default pizza
//
//        // creates a large pepperoni pizza with no extra toppings
//        Pizza_NoFileRead pizza2 = new Pizza_NoFileRead("Pepperoni Pizza", 17, 1, "pepperoni", "stuffed", "large");
//    }
//}
